...
- `## [ ] ID 제목` — 묶음. 한 묶음 = 브랜치 하나. 단계가 전부 통과해야 루프를 시작한 줄기(`3d-start` · `3d-lane2` …)에 합친다
...
- [x] 3. shot.sh 기본 해상도가 1280x720 이 아니다 — 대화 세션이 고쳤다 (2026-09-24) (G-129 단계 1)
...
- [x] 4. shot.sh 쓰임 줄이 낡았다 — 대화 세션이 고쳤다 (2026-09-24) (G-129 단계 3)
  - 뺀 까닭: harness/shot.sh — 세션은 하네스를 못 고친다
...
- [ ] 6. spec 에 토대 3×3 이 남았다 (2026-09-24 md 점검)

...
- [ ] 1. 다쳐서 도망간 뒤 진정하지 않는다 (G-130 단계 3)
...
- [ ] 3. 총을 들면 단추의 「(우클릭)」이 틀린다 (G-131 단계 3)
...
- [ ] 3. shot.sh 기본 해상도가 1280x720 이 아니다 (G-129 단계 1)
...
- [ ] 4. shot.sh 쓰임 줄이 낡았다 (G-129 단계 3)
  - 뺀 까닭: harness/shot.sh — 세션은 하네스를 못 고친다
...
- [ ] 5. 창이 떠 있어도 위 안내 줄이 걷기 안내다 (G-901 단계 1)

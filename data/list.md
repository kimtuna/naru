...
- [ ] 3. (앞 단계 QA) 횃불 · 건축물 · 선착장의 남은 대수 왕복 테스트가 없다
...
- QA 가 통과시키면서 찾은 것이다. **물어볼 것이 아니면 여기로 온다** (사람 결정 2026-09-22).
  루프가 제 손으로 갚는다 — 사람은 순서를 바꾸고 싶을 때만 손댄다
- 기능을 더하지 않는다. 지키는 것이 없던 자리에 지키는 것을 넣는 일이다
- [ ] 1. 벽에 박은 앵커가 저장되지 않는다 (G-990 단계 1)
  - 기준: ## [ ] G-920 루프가 찾은 것 — 스스로 갚는다
- QA 가 통과시키면서 찾은 것이다. **물어볼 것이 아니면 여기로 온다** (사람 결정 2026-09-22).
  루프가 제 손으로 갚는다 — 사람은 순서를 바꾸고 싶을 때만 손댄다
- 기능을 더하지 않는다. 지키는 것이 없던 자리에 지키는 것을 넣는 일이다
- [ ] 2. 웅크림 · 시선 방향이 저장되지 않는다 (G-990 단계 1)
...
- [ ] 5. 휘두를 때 캐릭터가 조준 쪽으로 안 돈다 (G-990 단계 1)
...
- [ ] 7. 제작대 목록 글이 붙어 읽기 어렵다 (G-990 단계 1)

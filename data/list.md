...
- [ ] 8. 사슬 끝 4 · 5번째 자리는 그 등급으로 바로 놓인다 (결정 대기 → 사람 결정 2026-09-26)
...
- [ ] 11. 횃불 놓기가 없어 미리보기도 없다 (G-150 단계 5)
  - 기준: 횃불 놓기가 없어 미리보기도 없다 — 기준에 횃불이 예로 적혔지만 게임에 횃불을 놓는 길이 없다 (spec/03_world/lighting.md 「들어도 · 놓아도 아무것도 안 밝다」). 횃불 놓기를 만드는 단계에서 그 놓는 곳을 Placeable.PLACERS 에 넣으면 test_placeable_previews.gd 가 그대로 잡는다 — 그 단계에 기준으로 「횃불도 미리보기가 뜬다」를 붙여라

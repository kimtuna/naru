...
- [ ] 9. 「임시」 표시를 붙인다 ② — 상자 · 제작 창 · 갈고리총 · spec 미정
...
- [ ] 13. 겹친 것을 하나로 — 테스트 안 중복 · 이름에 매인 단언
...
- [ ] 16. 섬 배선을 지키는 테스트 ② — 예광탄 · 붙이는 차례 · 음식
...
- [ ] 18. 껍데기 테스트를 고친다 ② — Tab · 재료 검사 · 제작대 레시피
...
- [ ] 19. 껍데기 테스트를 고친다 ③ — 부순 제작대 · 설치물 · 버퍼 시간
...
- [ ] 20. 껍데기 테스트를 고친다 ④ — 빈 총 · 총마다 다른 탄 · 맨손 사슬

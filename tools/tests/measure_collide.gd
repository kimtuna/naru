...
## **9판을 두 벌 쟀다** (2026-09-15 · `jitter.sh 9` × 2): 첫 벌 최대 2.830 · 폭 1.052 ·
## **둘째 벌 최대 4.061 · 폭 2.061**(해안 미끄럼. 바다로 직진은 두 벌 다 0.000).
## 한 벌만 봤으면 폭을 절반으로 봤다. 잡음 위 문턱은 4.061 + 2.061 = **6.122** 이고
## 10.0 은 그 위 · 고장 169.71 의 1/17 아래다 — 여유 **17.0배**.
const TOL_RATE := 10.0
